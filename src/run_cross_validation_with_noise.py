...
label_region_loader = LabelRegionLoader(introduce_noise=True)
DECO = Dataset(join(DATA_DIR, "Deco"), "Deco_w_noise", label_region_loader)
FUSTE = Dataset(join(DATA_DIR, "FusTe"), "FusTe_w_noise", label_region_loader)
TEST = Dataset(join(DATA_DIR, "Test"), "Test_w_noise", label_region_loader)
